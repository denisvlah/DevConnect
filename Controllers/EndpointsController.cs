...
public class EndpointsController : Controller
{
    ...
    {
        return _implementation.Get_accounts_account_accounts_getAsync(stack ?? "", firstName ?? "", lastName ?? "",
    ...
    public Task<Page_UserReadSchemaShort_> Get_subscriptions_account_subscriptions__get([FromQuery] string? stack,
        ...
        [FromQuery] string? orderBy, [FromQuery] int? page, [FromQuery] int? size, CancellationToken cancellationToken)
    {
        return _implementation.Get_subscriptions_account_subscriptions__getAsync(stack ?? "", firstName ?? "",
    ...
    {
        return _implementation.Get_subscribers_account_subscribers__getAsync(stack ?? "", firstLastName ?? "",
            city ?? "", orderBy ?? "", page ?? 1, size ?? 50, cancellationToken);
    }
    ...
    {
        return _implementation.Delete_image_post_delete_image__post_id__deleteAsync(post_id, image_url,
            cancellationToken);
    }
